...
public class Level13 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LinearLayout dialogfon = (LinearLayout)dialogEnd.findViewById(R.id.dialogfon);
        dialogfon.setBackgroundResource(R.drawable.previewbackgroundthirteenen);
        ...
        text_left.setText(array.texts13[numLeft]);// Достаем из массива текст
        ...
        text_right.setText(array.texts13[numRight]);// Достаем из массива текст
