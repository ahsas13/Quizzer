...
public class Level6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numLeft = random.nextInt(36); // случайное число от 0 до 9
        ...
        numRight = random.nextInt(36);// случайное число от 0 до 9

        while (array.poets[numLeft]==array.poets[numRight]){
            numRight = random.nextInt(36);
        }
        ...
        img_left.setOnTouchListener((v, event) -> {
            ...
            if (event.getAction() ==MotionEvent.ACTION_DOWN){
                ...
                if (array.poets[numLeft]>array.poets[numRight]){
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() ==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(36); // случайное число от 0 до 29
                        img_left.setImageResource(array.images6[numLeft]);// Достаем из массива картинку
                        text_left.setText(array.texts6[numLeft]);// Достаем из массива текст

                        numRight = random.nextInt(36);// случайное число от 0 до 29
