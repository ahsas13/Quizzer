...
public class Level5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        numLeft = random.nextInt(30); // случайное число от 0 до 9
        ...
        numRight = random.nextInt(30);// случайное число от 0 до 9
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() ==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(30); // случайное число от 0 до 29
                        img_left.setImageResource(array.images5[numLeft]);// Достаем из массива картинку
                        text_left.setText(array.texts5[numLeft]);// Достаем из массива текст

                        numRight = random.nextInt(30);// случайное число от 0 до 29
