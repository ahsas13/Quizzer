...
public class Level12 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_left.setText(array.texts12[numLeft]);// Достаем из массива текст

        numRight = random.nextInt(50);

        while (array.capitals[numLeft]==array.capitals[numRight]){
            numRight = random.nextInt(50);
        }
        img_right.setImageResource(array.images12[numRight]);// Достаем из массива картинку
        text_right.setText(array.texts12[numRight]);// Достаем из массива текст
        ...
        img_left.setOnTouchListener((v, event) -> {
            ...
            if (event.getAction() ==MotionEvent.ACTION_DOWN){
                ...
                if (array.capitals[numLeft]>array.capitals[numRight]){
