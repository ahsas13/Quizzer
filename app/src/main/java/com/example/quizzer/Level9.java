...
public class Level9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        img_left.setImageResource(array.images9[currentIndex]);
        text_left.setText(array.texts9[currentIndex]);
        currentIndex++;

        img_right.setImageResource(array.images9[currentIndex]);
        text_right.setText(array.texts9[currentIndex]);
        currentIndex++;
        ...
        img_left.setOnTouchListener((v, event) -> {
            if (event.getAction() == MotionEvent.ACTION_DOWN) {
                ...
                if (count == 20) {
                    ...
                    if (currentIndex >= array.images9.length) {
