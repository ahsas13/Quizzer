...
public class Level10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text_left.setText(array.texts10[numLeft]);// Достаем из массива текст
        ...
        text_right.setText(array.texts10[numRight]);// Достаем из массива текст
            ...
            public boolean onTouch(View v, MotionEvent event) {
                ...
                if (event.getAction() ==MotionEvent.ACTION_DOWN){
                    ...
                    if (count==20){
                        ...
                        numLeft = random.nextInt(16); // случайное число от 0 до 9
                        img_left.setImageResource(array.images10[numLeft]);// Достаем из массива картинку
                        img_left.startAnimation(a);
                        text_left.setText(array.texts10[numLeft]);// Достаем из массива текст

                        numRight = random.nextInt(16);// случайное число от 0 до 9
